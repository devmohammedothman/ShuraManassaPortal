    ...
    data: {
        ...
        'CONT': {
            ...
            'WISHES': {
                ...
                'NOTES': 'ملاحظات',  
                'CHECKMEMEXPERROR':'برجاء إختيار رغبة واحدة علي الأقل متوافقة مع التخصصات أو الخبرات المطلوبة للجان',
                'MEMNOEXPERROR' : 'لم يتم تحديد تخصصات أو خبرات لهذا العضو'
            },
            'GPERM': {
                'TITLE': 'صلاحيات المجموعات',
                'SUBTITLE': 'تخصيص الصلاحيات',
                'SUBTITLE-GU': 'تخصيص الأعضاء للمجموعات',
                'GNAME': 'اختر اسم المجموعة!',
                'UNAME': 'اختر اسم العضو!',
                'READ': 'صلاحية القراءة',
                'WRITE': 'صلاحية التعديل'
            },
            'COMMITTE': {
                'TITLE': 'اللجان',
